    ...
    {jobs.map((job, index) => (
      <Card key={index} sx={{ maxWidth: 345, marginBottom: 2 }} className='card'>
        ...
        <CardActions className='button'>
          <Button size="small" color="success" variant="contained" onClick={()=>Nav(`/Edit/${index}`)} >Edit</Button>
          <Button size="small" color="error" variant="contained" onClick={()=>handleOpen(index)} >Delete</Button>
          </CardActions>
          <Modal
        open={open}
        onClose={handleClose}
